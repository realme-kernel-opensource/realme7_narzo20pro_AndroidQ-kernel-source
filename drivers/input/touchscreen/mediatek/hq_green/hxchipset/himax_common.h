...
#define HIMAX_DRIVER_VER "1.3.0.11_OPPO_HuaQin_00"
...
//#define HX_FREQ_HOP					/* default unsue */
//#define HX_UPDATE_FW_NOTIFIER 			/* default unsue */
//#define HX_TP_USB_NOTIFIER 			/* default unsue */
//#define HX_TP_HEADSET_NOTIFIER 		/* default unsue */
...
#define HX_HEADSET_DETECT_GLOBAL
#else
#define HX_HEADSET_DETECT_GLOBAL
#endif
...
#ifdef CONFIG_FB
#undef CONFIG_FB /* in case of suppend/resume twice */
#endif

#if defined(HX_ZERO_FLASH)
//#define HX_SPI_BUS_INIT
#endif

#if defined(HX_AUTO_UPDATE_FW) || defined(HX_ZERO_FLASH)
#define HX_FW_DOWNLOAD_COMPATIBLE_I_FILE
#endif
...
struct himax_ts_data {
	...
	struct mutex resume_update_fw_lock;
...
/******* SPI-end *******/
	...
	//struct work_struct usb_detect_work_queue;
