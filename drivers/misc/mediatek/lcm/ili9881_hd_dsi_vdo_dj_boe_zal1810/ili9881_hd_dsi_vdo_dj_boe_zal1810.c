...
static struct LCM_setting_table init_setting_vdo[] = {
    ...
    {0xE0,27,{0x00,0x24,0x41,0x5C,0x85,0x40,0xAC,0xCE,0xFA,0x20,0x55,0x61,0x98,0xCC,0xFF,0xAA,0x34,0x73,0x9A,0xCA,0xFE,0xF3,0x27,0x65,0x9A,0x03,0xEC}},
    {0xE1,27,{0x00,0x24,0x41,0x5C,0x85,0x40,0xAC,0xCE,0xFA,0x20,0x55,0x61,0x98,0xCC,0xFF,0xAA,0x34,0x73,0x9A,0xCA,0xFE,0xF3,0x27,0x65,0x9A,0x03,0xEC}},
...
#endif
#ifndef BUILD_LK
    register_device_proc("lcd", "ili9881_dj", "ilitek");
#endif
}
...
{
    printk("%s,dj_ili9881c dj backlight: level = %d\n", __func__, level);
...
struct LCM_DRIVER ili9881_hd_dsi_vdo_dj_boe_zal1810_lcm_drv = {
    .name = "ili9881_dj_boe",
