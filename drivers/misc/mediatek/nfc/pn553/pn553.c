...
#endif
#ifdef CONFIG_HQ_HARDWARE_INFO	//add for hardwareinfo
#include <linux/hardware_info.h>
#endif
#include "../../../../pinctrl/core.h"

#include "../../include/mt-plat/mtk_boot_common.h"
			...
			const struct i2c_device_id *id)
{
	...
	*/
	...
	ret = pn553_hw_check(client, pn553_dev);
	if (ret) {
		//goto err_request_hw_check_failed;
	} else {
#ifdef CONFIG_HQ_HARDWARE_INFO
		get_hardware_info_data(HWID_NFC, PN553_DRVNAME);
#endif
	}
