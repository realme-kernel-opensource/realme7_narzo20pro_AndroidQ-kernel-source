			...
			*sensor_id = (((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001)) & 0x0fff);
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if (deviceInfo_register_value == 0x00) {
					...
					//	sprintf(sensor_name_golden_result, "%s_1", DEVICE_VERSION_S5KGM1SP);
					//} else {
					//	sprintf(sensor_name_golden_result, "%s_0", DEVICE_VERSION_S5KGM1SP);
					//}
					//register_imgsensor_deviceinfo("Cam_r", sensor_name_golden_result, module_id);
			...
			printk("Read sensor id fail, id: 0x%x ensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
			retry--;
		} while(retry > 0);
		i++;
		retry = 2;
