...
#define GC13C33_MIRROR_FLIP_ENABLE   1
#if GC13C33_MIRROR_FLIP_ENABLE
#define GC13C33_MIRROR    0x03
#define GC13C33_DPC_RULE          0x50
#else
#define GC13C33_MIRROR            0x00
#define GC13C33_DPC_RULE          0x60
#endif

#define SENSOR_BASE_GAIN       0x400
#define SENSOR_MAX_GAIN        (16 * SENSOR_BASE_GAIN)

#define DPC_BUF_SIZE 802 /*200x4+2*/
...
extern void gc13c33_otp_copy_dpc_data(kal_uint8 *dpc_data);
extern void gc13c33_copy_crosstalk_data(kal_uint8 *ct_data);
extern void gc13c33_otp_identify(void);
extern void gc13c33_otp_function(void);
