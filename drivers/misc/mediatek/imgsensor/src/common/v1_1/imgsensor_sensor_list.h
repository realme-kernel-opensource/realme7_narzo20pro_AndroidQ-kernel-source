...
UINT32 IMX682_MIPI_RAW_SensorInit(SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 S5KGW1_MIPI_RAW_SensorInit(SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 S5KGM1SP_MIPI_RAW_SensorInit(SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 IMX471_MIPI_RAW_SensorInit(SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 S5K3P9SP_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 OV8856_MIPI_RAW_SensorInit(SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV02B10_MIPI_RAW_SensorInit(SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 OV02B1B_MIPI_MONO_SensorInit(SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC2375H_MIPI_RAW_SensorInit(SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC02M0_MIPI_MONO_SensorInit(SENSOR_FUNCTION_STRUCT **pfFunc);
UINT32 GC02K0_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
UINT32 OV02A10_MIPI_RAW_SensorInit(SENSOR_FUNCTION_STRUCT **pfFunc);
#endif
