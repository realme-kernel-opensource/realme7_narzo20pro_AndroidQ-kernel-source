...
static struct adsp_reserve_mblock adsp_reserve_mblocks[] = {
	...
	[ADSP_A_LOGGER_MEM_ID]      = ADSP_RESERVE_MEMORY_BLOCK(0x80000),
	[ADSP_VOIP_MEM_ID]          = ADSP_RESERVE_MEMORY_BLOCK(0),
	...
	[ADSP_CAPTURE_UL1_MEM_ID]   = ADSP_RESERVE_MEMORY_BLOCK(0),
	[ADSP_DATAPROVIDER_MEM_ID]  = ADSP_RESERVE_MEMORY_BLOCK(0),
	[ADSP_CALL_FINAL_MEM_ID]    = ADSP_RESERVE_MEMORY_BLOCK(0x18000),
	[ADSP_KTV_MEM_ID]           = ADSP_RESERVE_MEMORY_BLOCK(0x10000),
	[ADSP_A_DEBUG_DUMP_MEM_ID]  = ADSP_RESERVE_MEMORY_BLOCK(0x20000),
	[ADSP_A_CORE_DUMP_MEM_ID]   = ADSP_RESERVE_MEMORY_BLOCK(0x1000),
#endif
};
