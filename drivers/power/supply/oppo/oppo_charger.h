...
typedef enum {
        ...
        LED_TEMP_STATUS__LIMIT_HIGH,                      /*>37 && <=44C*/
        LED_TEMP_STATUS__HIGH,                            /*>44C*/
}
...
/*Sidong.Zhao@ODM_WT.BSP.CHG 2019/11/27,AP thermal machine*/
	...
	int charge_current_calling_ma;
        ...
        int led_limit_high_bat_decidegc;                /*>=44C*/
        int led_limit_high_bat_decidegc_antishake;
        int input_current_led_ma_limit_high;
